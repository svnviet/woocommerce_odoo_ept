...
class woo_product_template_ept(models.Model):
    ...
    def woo_unpublished(self):
        ...
        if self.woo_tmpl_id:
            ...
            try:
                ...
                transaction_log_obj.create({
                    'message': "Json Error : While Unpublish Product with id %s from WooCommerce for instance %s. \n%s" % (
                        self.woo_tmpl_id, instance.name, e),
                    'mismatch_details': True,
                    'type': 'product',
                    'woo_instance_id': instance.id
                })
    ...
    def woo_published(self):
        ...
        if self.woo_tmpl_id:
            ...
            try:
                ...
                transaction_log_obj.create({
                    'message': "Json Error : While Publish Product with id %s from WooCommerce for instance %s. \n%s" % (
                        self.woo_tmpl_id, instance.name, e),
                    'mismatch_details': True,
                    'type': 'product',
                    'woo_instance_id': instance.id
    ...
    def sync_new_woo_categ_with_product(self, wcapi, instance, woo_categories, sync_images_with_product=True):
        ...
        for woo_category in woo_categories:
            woo_product_categ = obj_woo_product_categ.search(
                [('woo_categ_id', '=', woo_category.get('id')), ('woo_instance_id', '=', instance.id)], limit=1)
            if not woo_product_categ:
                woo_product_categ = obj_woo_product_categ.search(
                    [('slug', '=', woo_category.get('slug')), ('woo_instance_id', '=', instance.id)], limit=1)
            if woo_product_categ:
                woo_product_categ.write({'woo_categ_id': woo_category.get('id'), 'name': woo_category.get('name'),
    ...
    def sync_new_woo_tags_with_product(self, wcapi, instance, woo_tags):
        ...
        for woo_tag in woo_tags:
            woo_product_tag = obj_woo_product_tags.search(
                [('woo_tag_id', '=', woo_tag.get('id')), ('woo_instance_id', '=', instance.id)], limit=1)
            if not woo_product_tag:
                woo_product_tag = obj_woo_product_tags.search(
                    [('slug', '=', woo_tag.get('slug')), ('woo_instance_id', '=', instance.id)], limit=1)
            if woo_product_tag:
                ...
                woo_product_tag = obj_woo_product_tags.create(
                    {'woo_tag_id': woo_tag.get('id'), 'name': woo_tag.get('name'), 'slug': woo_tag.get('slug'),
                     'woo_instance_id': instance.id, 'exported_in_woo': True})
                obj_woo_product_tags.sync_product_tags(instance, woo_product_tag=woo_product_tag)
    ...
    def sync_woo_tags_with_product(self, wcapi, instance, woo_tags):
        ...
        for woo_tag in woo_tags:
            ...
            self._cr.execute("select id from woo_tags_ept where LOWER(name) = '%s' and woo_instance_id = %s limit 1" % (
                tag, instance.id))
            ...
            if woo_product_tag_id:
                ...
                try:
                    ...
                    transaction_log_obj.create({
                        'message': "Json Error : While Sync Product Tags from WooCommerce for instance %s. \n%s" % (
                            instance.name, e),
                        'mismatch_details': True,
                        'type': 'product',
                        'woo_instance_id': instance.id
                ...
                for product_tag in product_tags:
                    ...
                    if tag_name == woo_tag:
                        ...
                        try:
                            ...
                            transaction_log_obj.create({
                                'message': "Json Error : While Sync Product Tag with id %s from WooCommerce for instance %s. \n%s" % (
                        ...
                        tag_vals = {'name': woo_tag, 'woo_instance_id': instance.id,
                                    'description': single_tag.get('description'), 'exported_in_woo': True,
                                    'woo_tag_id': single_tag.get('id')}
    ...
    def import_all_attribute_terms(self, wcapi, instance, woo_attribute_id, transaction_log_obj, page):
        if instance.woo_version == 'new':
            res = wcapi.get(
                "products/attributes/%s/terms?per_page=100&page=%s" % (woo_attribute_id.woo_attribute_id, page))
        else:
            res = wcapi.get(
                "products/attributes/%s/terms?filter[limit]=1000&page=%s" % (woo_attribute_id.woo_attribute_id, page))
        if not isinstance(res, requests.models.Response):
            transaction_log_obj.create(
                {'message': "Get All Attibute Terms \nResponse is not in proper format :: %s" % (res),
                 'mismatch_details': True,
                 'type': 'product',
                 'woo_instance_id': instance.id
                 })
        ...
        try:
            ...
            transaction_log_obj.create({
                'message': "Json Error : While import product attribute terms from WooCommerce for instance %s. \n%s " % (
                    instance.name, e),
                'mismatch_details': True,
                'type': 'product',
                'woo_instance_id': instance.id
            ...
            if total_pages:
                if int(total_pages) >= 2:
                    for page in range(2, int(total_pages) + 1):
                        attributes_term_data = attributes_term_data + self.import_all_attribute_terms(wcapi, instance,
                                                                                                      woo_attribute,
                                                                                                      transaction_log_obj,
                                                                                                      page)
                ...
                for attribute_term in attributes_term_data:
                    woo_attribute_term = obj_woo_attribute_term.search(
                        [('woo_attribute_term_id', '=', attribute_term.get('id')),
                         ('woo_instance_id', '=', instance.id), ('exported_in_woo', '=', True)], limit=1)
                    ...
                    if not odoo_attribute_value:
                        odoo_attribute_value = odoo_attribute_value.with_context(active_id=False).create(
                            {'name': attribute_term.get('name'), 'attribute_id': woo_attribute.attribute_id.id})
                    woo_attribute_term = obj_woo_attribute_term.search(
                    ...
                    if woo_attribute_term:
                        woo_attribute_term.write(
                            {'woo_attribute_term_id': attribute_term.get('id'), 'count': attribute_term.get('count'),
                             'slug': attribute_term.get('slug'), 'exported_in_woo': True})
                    else:
                        obj_woo_attribute_term.create(
                            {'name': attribute_term.get('name'), 'woo_attribute_term_id': attribute_term.get('id'),
                             'slug': attribute_term.get('slug'), 'woo_instance_id': instance.id,
                             'attribute_value_id': odoo_attribute_value.id,
    ...
    def import_all_attributes(self, wcapi, instance, transaction_log_obj, page):
        ...
        try:
            ...
            transaction_log_obj.create({
                'message': "Json Error : While import product attributes from WooCommerce for instance %s. \n%s " % (
                    instance.name, e),
                'mismatch_details': True,
                'type': 'product',
                'woo_instance_id': instance.id
    ...
    def sync_woo_attribute(self, instance):
        ...
        try:
            ...
            return False
        if instance.woo_version == 'old':
            attributes_data = response.json().get('product_attributes')
        total_pages = 1
        if instance.woo_version == 'old':
            total_pages = response and response.headers.get('X-WC-TotalPages') or 1
        elif instance.woo_version == 'new':
        ...
        if not isinstance(attributes_data, list):
            transaction_log_obj.create({'message': "Attribute data \nResponse is not in proper format :: %s" % (attributes_data),
                                        'mismatch_details': True,
                                        'type': 'product',
                                        'woo_instance_id': instance.id
                                        })
        ...
        if total_pages:
            if int(total_pages) >= 2:
                for page in range(2, int(total_pages) + 1):
                    attributes_data = attributes_data + self.import_all_attributes(wcapi, instance, transaction_log_obj,
                                                                                   page)
        if response.status_code in [201, 200]:
            for attribute in attributes_data:
                woo_attribute = obj_woo_attribute.search(
                    [('woo_attribute_id', '=', attribute.get('id')), ('woo_instance_id', '=', instance.id),
                ...
                woo_attribute = obj_woo_attribute.search(
                    [('attribute_id', '=', odoo_attribute.id), ('woo_instance_id', '=', instance.id),
                     ('exported_in_woo', '=', False)], limit=1)
                if woo_attribute:
                    woo_attribute.write({'woo_attribute_id': attribute.get('id'), 'order_by': attribute.get('order_by'),
                                         'slug': attribute.get('slug'), 'exported_in_woo': True,
                                         'has_archives': attribute.get('has_archives')})
                else:
                    obj_woo_attribute.create({'name': attribute.get('name'), 'woo_attribute_id': attribute.get('id'),
    ...
    def  export_product_attributes_in_woo(self, instance, attribute):
        ...
        obj_woo_attribute.create(
            {'name': attribute and attribute.name or woo_attribute_name, 'woo_attribute_id': woo_attribute_id,
        ...
        for variation in result.get('variations'):
            ...
            for variation_attribute in variation_attributes:
                ...
                if instance.attribute_type == 'text':
                    ...
                    if product_attribute:
                        product_attribute_value = product_attribute_value_obj.search(
                            [('attribute_id', '=', product_attribute.id), ('name', '=ilike', attribute_val)], limit=1)
                ...
                if instance.attribute_type == 'select':
                    ...
                    if woo_product_attribute:
                        woo_product_attribute_term = woo_attribute_term_obj.search(
                            [('woo_attribute_id', '=', woo_product_attribute.woo_attribute_id),
                             ('name', '=ilike', attribute_val)], limit=1)
                        if not woo_product_attribute_term:
                            woo_product_attribute_term = woo_attribute_term_obj.search(
                                [('woo_attribute_id', '=', woo_product_attribute.woo_attribute_id),
                                 ('slug', '=ilike', attribute_val)], limit=1)
                        woo_product_attribute_term and attribute_value_ids.append(
            ...
            if odoo_product and sync_price_with_product:
                pricelist_item = self.env['product.pricelist.item'].search(
                    [('pricelist_id', '=', instance.pricelist_id.id), ('product_id', '=', odoo_product.id)], limit=1)
    ...
    def create_variant_product(self, result, instance):
        ...
        for attrib in result.get('attributes'):
            ...
            if attr_val_ids:
                attribute_line_desc_ids_data = [0, False,
                                           {'attribute_id': attribute.id, 'value_ids': [[6, False, attr_val_ids]]}]
                attrib_line_vals.append(attribute_line_desc_ids_data)
        if attrib_line_vals:
            product_template = product_template_obj.create({'name': template_title,
                                                            'type': 'product',
                                                            'attribute_line_desc_ids': attrib_line_vals,
                                                            'description_sale': result.get('description', '')})
            self.set_variant_sku(instance, result, product_template,
                                 sync_price_with_product=instance.sync_price_with_product)
        else:
            return False
        return True
            ...
            if res_image_src:
                if position == 0:
                    ...
                    if not instance.is_image_url and result.get('variations'):
                        woo_template.product_tmpl_id.write({'image': binary_img_data})
                        odoo_product_images and self.set_variant_images(odoo_product_images)
                woo_product_tmp_img = woo_product_img.search(
                    [('woo_product_tmpl_id', '=', woo_template.id), ('woo_instance_id', '=', instance.id),
                     ('woo_image_id', '=', image_id)], limit=1)
                if woo_product_tmp_img:
                    ...
                    if instance.is_image_url:
                        woo_product_img.create({'woo_instance_id': instance.id, 'sequence': position,
                                                'woo_product_tmpl_id': woo_template.id, 'response_url': res_image_src,
                                                'woo_image_id': image_id})
                    else:
                        woo_product_img.create({'woo_instance_id': instance.id, 'sequence': position,
                                                'woo_product_tmpl_id': woo_template.id, 'image': binary_img_data,
                                                'woo_image_id': image_id})
    ...
    def get_product_response(self, instance, woo_tmpl_id, wcapi, transaction_log_obj):
        ...
        if instance.is_latest:
            _logger.info(' Total Products of Woo {}'.format(len(results)))
            for result in results:
                variants = []
                woo_id = result.get('id')
                for variant in result.get('variations'):
                    try:
                        _logger.info('Woo Teplate Id  {} and request for variant Id {}'.format(woo_id, variant))
    ...
    def sync_products(self, instance, woo_tmpl_id=False, update_price=False, update_templates=True,
                      sync_images_with_product=False, skip_existing_products=False):
        if instance.attribute_type == 'select':
            self.sync_woo_attribute(instance)
        woo_product_obj = self.env['woo.product.product.ept']
        transaction_log_obj = self.env["woo.transaction.log"]
        ...
        if woo_tmpl_id:
            ...
            try:
                ...
                transaction_log_obj.create({
                    'message': "Json Error : While Sync Draft Products from WooCommerce for instance %s. \n%s" % (
                        instance.name, e),
                    'mismatch_details': True,
                    'type': 'product',
                    'woo_instance_id': instance.id
        ...
        for result in results:
            ...
            woo_template = self.search([('woo_tmpl_id', '=', woo_tmpl_id), ('woo_instance_id', '=', instance.id)],
                                       limit=1)
            ...
            for variation in result.get('variations'):
                ...
                woo_product = woo_product_obj.search(
                    [('variant_id', '=', variant_id), ('woo_instance_id', '=', instance.id)], limit=1)
                if not woo_product:
                    woo_product = woo_product_obj.search(
                        [('default_code', '=', sku), ('woo_instance_id', '=', instance.id)], limit=1)
                if not woo_product:
                    woo_product = woo_product_obj.search(
                        [('product_id.default_code', '=', sku), ('woo_instance_id', '=', instance.id)], limit=1)
                if not woo_product:
                ...
                variant_info = {'name': template_title, 'default_code': sku, 'created_at': created_at,
                ...
                if not woo_product:
                    if not woo_template:
                        ...
                        tmpl_info.update(
                            {'product_tmpl_id': odoo_product.product_tmpl_id.id, 'woo_instance_id': instance.id,
                    ...
                    if update_price:
                        pricelist_item = self.env['product.pricelist.item'].search(
                            [('pricelist_id', '=', instance.pricelist_id.id), ('product_id', '=', odoo_product.id)],
                            limit=1)
                        if not pricelist_item:
                            instance.pricelist_id.write({
                                'item_ids': [(0, 0, {
            ...
            if not result.get('variations'):
                ...
                woo_product = woo_product_obj.search(
                    [('variant_id', '=', woo_tmpl_id), ('woo_instance_id', '=', instance.id)], limit=1)
                if not woo_product:
                    woo_product = woo_product_obj.search(
                        [('default_code', '=', sku), ('woo_instance_id', '=', instance.id)], limit=1)
                if not woo_product:
                        ...
                        if woo_product_tmp_img:
                            ...
                            if instance.is_image_url:
                                woo_product_img.create({'woo_instance_id': instance.id, 'sequence': position,
                                                        ...
                                                        'response_url': res_image_src, 'woo_image_id': image_id})
                            else:
                                woo_product_img.create({'woo_instance_id': instance.id, 'sequence': position,
                                                        'woo_product_tmpl_id': woo_template.id,
                                                        'image': binary_img_data, 'woo_image_id': image_id})
            self._cr.commit()
        return True
    ...
    def sync_new_products(self, instance, woo_tmpl_id=False, update_price=False, update_templates=True,
        ...
        if categ_and_tag_imported:
            self.env['woo.product.categ.ept'].sync_product_category(instance,
                                                                    sync_images_with_product=sync_images_with_product)
        ...
        for result in results:
            ...
            woo_tmpl_id = result.get('id')
            template_title = result.get('name')
            _logger.info(' Creating Woo product Id {}'.format(woo_tmpl_id))
            ...
            for variation in result.get('variations'):
                ...
                variant_info = {'name': template_title, 'default_code': sku, 'created_at': created_at or False,
                                'updated_at': updated_at or False, 'producturl': product_url or False}
                if instance.is_image_url and sync_images_with_product:
                    variant_info.update({'response_url': var_image_src, 'woo_image_id': var_image_id})
                ...
                if not woo_product:
                    if not woo_template:
                        ...
                        if not categ_and_tag_imported:
                            ...
                            woo_categs = []
                            for woo_category in woo_categories:
                                woo_categ = woo_category.get('id') and self.env['woo.product.categ.ept'].search(
                    ...
                    if not instance.is_image_url and sync_images_with_product:
                        odoo_product_images.append(
                            {'odoo_product': odoo_product, 'image': var_img if woo_product else None, 'sku': sku})
                    if update_price:
                        pricelist_item = self.env['product.pricelist.item'].search(
                            [('pricelist_id', '=', instance.pricelist_id.id), ('product_id', '=', odoo_product.id)],
                            limit=1)
    ...
    def set_old_products_images_in_woo(self, instance):
        ...
        for template in self:
            ...
            try:
                ...
                transaction_log_obj.create({
                    'message': "Json Error : While update product image for product with id %s to WooCommerce for instance %s. \n%s" % (
                        template.woo_tmpl_id, instance.name, e),
                    'mismatch_details': True,
                    'type': 'product',
                    'woo_instance_id': instance.id
                })
            ...
            for tmpl_gallery_image in tmpl_update_response.get('images'):
                ...
                if not odoo_template.attribute_line_desc_ids and response_image_position == 0:
                    continue
                if instance.is_image_url:
                ...
                woo_product_tmp_img = woo_product_img.search(
                    [('woo_product_tmpl_id', '=', template.id), ('woo_instance_id', '=', instance.id)], offset=offset,
                    limit=1)
            ...
            for variant in template.woo_product_ids:
                if not variant.variant_id or not variant.product_id.attribute_line_desc_ids:
                    continue
                info = {}
                var_url = ''
                if instance.is_image_url:
                    ...
                    if variant.product_id.image:
                        ...
                        if not key in variant_img_keys:
                            res = img_file_upload.upload_image(instance, variant.product_id.image,
        ...
        for woo_templates in batches:
            ...
            if batch_update_data:
                ...
                try:
                    ...
                    transaction_log_obj.create({
                        'message': "Json Error : While update product images to WooCommerce for instance %s. \n%s" % (
                            instance.name, e),
                        'mismatch_details': True,
                        'type': 'product',
                        'woo_instance_id': instance.id
    ...
    def auto_update_stock_ept(self, ctx={}):
        ...
        if instance.state != 'confirmed':
            transaction_log_obj.create({
                'message': "While the update stock, Instance(%s) is not in confirm state.\n Please set schedule activity False, schedule activity name like '%s : Update Woo Stock' " % (
        ...
        if woo_instance_id:
            woo_templates = woo_product_tmpl_obj.search(
                [('woo_instance_id', '=', woo_instance_id), ('exported_in_woo', '=', True)])
            instance = self.env['woo.instance.ept'].browse(woo_instance_id)
    ...
    def update_stock_in_woo(self, instance=False, products=False):
        ...
        for instance in instances:
            ...
            if not products:
                ...
                woo_products = self.search(
                    [('woo_instance_id', '=', instance.id), ('exported_in_woo', '=', True), ('id', 'in', products.ids)])
            if not woo_products:
                continue
            wcapi = instance.connect_in_woo()
                        ...
                        if variant.variant_id and variant.product_id.type == 'product':
                            ...
                            if template.woo_tmpl_id != variant.variant_id:
                                info.get('variations').append(
                                    {'id': variant.variant_id, 'managing_stock': True, 'stock_quantity': int(quantity)})
                                flag = True
                            elif template.woo_tmpl_id == variant.variant_id:
                                del info['variations']
            ...
            for variant in woo_template.woo_product_ids:
                ...
                if not variant.variant_id:
                    ...
                    try:
                        ...
                        transaction_log_obj.create({
                            'message': "Json Error : While update product price to WooCommerce for instance %s. \n%s" % (
                                instance.name, e),
                            'mismatch_details': True,
                            'type': 'product',
                            'woo_instance_id': instance.id
                ...
                for variant in woo_template.woo_product_ids:
                    if variant.variant_id:
                        ...
                        if woo_template.woo_tmpl_id != variant.variant_id:
                            info.get('variations').append(
                                {'id': variant.variant_id, 'regular_price': str(price), 'sale_price': str(price)})
                            flag = True
    ...
    def get_product_attribute(self, template, instance):
        ...
        is_variable = False
        attributes = []
        for attribute_line in template.attribute_line_desc_ids:
            options = []
        ...
        for document in template.attachments:
            if document.attachment:
                slug = document.name.lower().replace(' ', '-')
                res = img_file_upload.upload_image(instance, document.attachment, slug + f'_{document.id}')
                attribute_data = {
                    'name': document.name,
                    'slug': slug,
                    'visible': True,
        ...
        for attribute_value in variant.product_id.attribute_value_ids:
            if instance.attribute_type == 'select':
                woo_attribute = woo_attribute_obj.search(
                    [('name', '=', attribute_value.attribute_id.name), ('woo_instance_id', '=', instance.id),
                     ('exported_in_woo', '=', True)], limit=1)
    ...
    @api.multi
    def get_product_data(self, wcapi, instance, woo_template, publish, update_price, update_stock, update_image,
                         template):
        transaction_log_obj = self.env['woo.transaction.log']
        categ_ids = []
        tag_ids = []
        ...
        for woo_categ in woo_template.woo_categ_ids:
            if not woo_categ.woo_categ_id:
                ...
                try:
                    ...
                    transaction_log_obj.create({
                        'message': "Json Error : While import product category from WooCommerce for instance %s. \n%s" % (
                            instance.name, e),
                        'mismatch_details': True,
                        'type': 'product',
                        'woo_instance_id': instance.id
        ...
        for woo_tag in woo_template.woo_tag_ids:
            if not woo_tag.woo_tag_id:
                ...
                try:
                    ...
                    transaction_log_obj.create({
                        'message': "Json Error : While import product tag from WooCommerce for instance %s. \n%s" % (
                            instance.name, e),
                        'mismatch_details': True,
                        'type': 'product',
                        'woo_instance_id': instance.id
    ...
    def update_products_in_woo(self, instance, templates, update_image):
        ...
        for template in templates:
            ...
            data = {'title': template.name, 'enable_html_description': True, 'enable_html_short_description': True,
                    'description': template.description or '',
                    'weight': template.product_tmpl_id.weight, 'short_description': template.short_description or '',
                    'taxable': template.taxable and 'true' or 'false'}

            tmpl_images = []
            position = 0

            if not odoo_template.attribute_line_desc_ids and template.woo_tmpl_id == template.woo_product_ids[0].variant_id:
                position = 1
            if update_image:
                gallery_img_keys = {}
                key = False
            ...
            try:
                ...
                transaction_log_obj.create({
                    'message': "Json Error : While update product with id %s to WooCommerce for instance %s. \n%s" % (
                        template.woo_tmpl_id, instance.name, e),
                    'mismatch_details': True,
                    'type': 'product',
                    'woo_instance_id': instance.id
        ...
        for woo_template in woo_templates:
            ...
            for response_variation in response_variations:
                ...
                woo_product = woo_product_product_ept.search(
                    [('default_code', '=', variant_sku), ('woo_template_id', '=', woo_template.id),
                     ('woo_instance_id', '=', instance.id)])
            ...
            for tmpl_image in tmpl_images:
                ...
                if not template.attribute_line_desc_ids and position == 0:
                    continue
                if instance.is_image_url:
                ...
                self._cr.execute(
                    "select id from woo_product_image_ept where woo_product_tmpl_id='%s' and woo_instance_id='%s' limit 1 offset '%s'" % (
                        woo_template.id, instance.id, offset))
            ...
            if updated_at.startswith('-'):
                updated_at = updated_at[1:]
            if not template.attribute_line_desc_ids:
                woo_product = woo_template.woo_product_ids
                woo_product.write({'variant_id': woo_tmpl_id, 'created_at': created_at, 'updated_at': updated_at,
                                   'exported_in_woo': True})
            tmpl_data = {'woo_tmpl_id': woo_tmpl_id, 'created_at': created_at, 'updated_at': updated_at,
                         'exported_in_woo': True}
    ...
    def export_new_products_in_woo(self, instance, woo_templates, update_price, update_stock, publish, update_image):
        ...
        for woo_template in woo_templates:
            ...
            if woo_tmpl_id and instance.is_latest and variants:
                ...
                for woo_variants in vairant_batches:
                    ...
                    try:
                        ...
                        transaction_log_obj.create({
                            'message': "Json Error : While retrive product response from WooCommerce for instance %s. \n%s" % (
                                instance.name, e),
                            'mismatch_details': True,
                            'type': 'product',
                            'woo_instance_id': instance.id
            ...
            if template.product_variant_count == 1:
                woo_product = woo_template.woo_product_ids
                woo_product.write(
                    {'variant_id': woo_tmpl_id, 'created_at': created_at or False, 'updated_at': updated_at or False,
                     'exported_in_woo': True})
            total_variants_in_woo = response.get('variations') and len(response.get('variations')) or 1
            tmpl_data = {'woo_tmpl_id': woo_tmpl_id, 'created_at': created_at or False,
